...
zacks <- read_html("https://www.zacks.com/stocks/buy-list/?adid=zp_topnav_1list")

##/html/body/div[4]/div[2]/section/div[2]/div/table/tbody

##//*[@id='full_one_list_table_full_one_list']

tbl <- zacks %>% html_node(xpath = "//*[@id='full_one_list_table_full_one_list']")

tbl <- zacks %>% html_node(xpath = "/html/body/div[4]/div[2]/section/div[2]/div/table/tbody")
