...
for(i in 1:5)
  ...
  for(j in 1:5)
    {
    #print(j)
    zacksList <- zacks %>% html_node(xpath = paste0("/html/body/div[5]/div[2]/section[2]/div/section[1]/div[",i,"]/table/tbody/tr[",j,"]/td[1]/a")) %>% html_attr("rel")
    zacksList2 <- paste0(zacksList,",",zacksList2)
    }
}

write.csv(zacksList2, paste0(format(Sys.time(), "%d-%b-%Y %H.%M"), "zacksList2.txt"), col.names = F, row.names = F)

zacks %>% html_node(xpath = paste0("/html/body/div[5]/div[2]/section[2]/div/section[1]/div[",i,"]/table/tbody/tr[",j,"]/td[1]/td[1]/a")) #%>% html_attr("rel")

path <- paste0("/html/body/div[5]/div[2]/section[2]/div/section[1]/div[",i,"]/table/tbody/tr[",j,"]/td[1]/td[1]/a")
path


"/html/body/div[5]/div[2]/section[2]/div/section[1]/div[5]/table/tbody/tr[5]/td[1]/a"
"/html/body/div[5]/div[2]/section[2]/div/section[1]/div[5]/table/tbody/tr[5]/td[1]/td[1]/a"
